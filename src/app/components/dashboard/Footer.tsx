    ...
    <footer className="bg-gray-900 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center mb-4">
              ...
              <span className="font-bold text-xl">SubShare</span>
            </div>
            <p className="text-gray-400 text-sm mb-4">
              The smart way to share subscription costs with friends, family, and trusted partners.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white text-sm">Browse Groups</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white text-sm">Create Group</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white text-sm">Content Policy</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-gray-400 text-sm">support@subshare.com</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-gray-400 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="text-gray-400 text-sm">123 Sharing Street<br />San Francisco, CA 94107</span>
              </li>
            </ul>
            <div className="mt-4">
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">© 2025 SubShare. All rights reserved.</p>
